...
class MailMail(models.AbstractModel):
    ...
    def _send_prepare_values(self, partner=None):
        ...
        newsletter_string = '<tr><td align="center" style="min-width: 590px; padding: 8px; font-size:11px;"><a target="_blank" href="{}/website_custom_bta/subscribe?list_id={}&email={}" style="color: #875A7B;">Subscribe to our newsletter</a></td></tr>'.format(
            base_url,
            list_id,
